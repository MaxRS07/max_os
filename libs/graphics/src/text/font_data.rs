// Credits to https://github.com/susam/pcface
pub type FontData = [[u8; 16]; 256];

pub const PC_FACE_MODERNDOS_8X16_FONT_LIST: FontData = [
    [
    ...
    [
        0x00, 0x00, 0x00, 0x00, 0x6c, 0xee, 0xfe, 0xfe, 0xfe, 0x7c, 0x38, 0x10, 0x00, 0x00, 0x00,
        0x00,
    ], // [♥] (3)
    [
        0x00, 0x00, 0x00, 0x00, 0x10, 0x38, 0x7c, 0xfe, 0xfe, 0x7c, 0x38, 0x10, 0x00, 0x00, 0x00,
        0x00,
    ], // [♦] (4)
    [
        0x00, 0x00, 0x00, 0x18, 0x3c, 0x3c, 0x5a, 0xff, 0xff, 0x5a, 0x18, 0x3c, 0x00, 0x00, 0x00,
        0x00,
    ], // [♣] (5)
    [
        0x00, 0x00, 0x00, 0x10, 0x38, 0x7c, 0xfe, 0xfe, 0xee, 0x54, 0x10, 0x38, 0x00, 0x00, 0x00,
        0x00,
    ], // [♠] (6)
    [
    ...
    [
        0x00, 0x00, 0x1e, 0x0e, 0x1a, 0x30, 0x78, 0xcc, 0xcc, 0xcc, 0xcc, 0x78, 0x00, 0x00, 0x00,
        0x00,
    ], // [♂] (11)
    [
    ...
    [
        0x00, 0x08, 0x0c, 0x0a, 0x0a, 0x0a, 0x08, 0x08, 0x08, 0x78, 0xf8, 0x70, 0x00, 0x00, 0x00,
        0x00,
    ], // [♪] (13)
    [
        0x00, 0x10, 0x18, 0x14, 0x12, 0x1a, 0x16, 0x12, 0x12, 0x72, 0xf2, 0x62, 0x0e, 0x1e, 0x1c,
        0x00,
    ], // [♫] (14)
    [
        0x00, 0x00, 0x00, 0x10, 0x92, 0x7c, 0x6c, 0xc6, 0x6c, 0x7c, 0x92, 0x10, 0x00, 0x00, 0x00,
        0x00,
    ], // [☼] (15)
    [
        0x00, 0x00, 0x00, 0x80, 0xc0, 0xe0, 0xf8, 0xfe, 0xf8, 0xe0, 0xc0, 0x80, 0x00, 0x00, 0x00,
        0x00,
    ], // [►] (16)
    [
        0x00, 0x00, 0x00, 0x02, 0x06, 0x0e, 0x3e, 0xfe, 0x3e, 0x0e, 0x06, 0x02, 0x00, 0x00, 0x00,
        0x00,
    ], // [◄] (17)
    [
        0x00, 0x00, 0x10, 0x38, 0x7c, 0xd6, 0x10, 0x10, 0xd6, 0x7c, 0x38, 0x10, 0x00, 0x00, 0x00,
        0x00,
    ], // [↕] (18)
    [
    ...
    [
        0x00, 0x00, 0x7f, 0xdb, 0xdb, 0xdb, 0xdb, 0x7b, 0x1b, 0x1b, 0x1b, 0x1b, 0x00, 0x00, 0x00,
        0x00,
    ], // [¶] (20)
    [
    ...
    [
        0x00, 0x00, 0x10, 0x38, 0x7c, 0xd6, 0x10, 0x10, 0xd6, 0x7c, 0x38, 0x10, 0xfe, 0x00, 0x00,
        0x00,
    ], // [↨] (23)
    [
        0x00, 0x00, 0x10, 0x38, 0x7c, 0xd6, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x00, 0x00, 0x00,
        0x00,
    ], // [↑] (24)
    [
        0x00, 0x00, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0xd6, 0x7c, 0x38, 0x10, 0x00, 0x00, 0x00,
        0x00,
    ], // [↓] (25)
    [
        0x00, 0x00, 0x00, 0x00, 0x10, 0x18, 0x0c, 0xfe, 0x0c, 0x18, 0x10, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ], // [→] (26)
    [
        0x00, 0x00, 0x00, 0x00, 0x10, 0x30, 0x60, 0xfe, 0x60, 0x30, 0x10, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ], // [←] (27)
    [
    ...
    [
        0x00, 0x66, 0x66, 0x22, 0x22, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ], // ["] (34)
    [
        0x00, 0x00, 0x00, 0x00, 0x6c, 0x6c, 0xfe, 0x6c, 0x6c, 0xfe, 0x6c, 0x6c, 0x00, 0x00, 0x00,
        0x00,
    ], // [#] (35)
    [
        0x00, 0x10, 0x10, 0x7c, 0xd6, 0xd6, 0x70, 0x38, 0x1c, 0xd6, 0xd6, 0x7c, 0x10, 0x10, 0x00,
        0x00,
    ], // [$] (36)
    [
        0x00, 0x00, 0x60, 0x92, 0x96, 0x6c, 0x18, 0x30, 0x6c, 0xd2, 0x92, 0x0c, 0x00, 0x00, 0x00,
        0x00,
    ], // [%] (37)
    [
        0x00, 0x00, 0x38, 0x6c, 0x6c, 0x38, 0x30, 0x76, 0xdc, 0xcc, 0xcc, 0x76, 0x00, 0x00, 0x00,
        0x00,
    ], // [&] (38)
    [
        0x00, 0x18, 0x18, 0x08, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ], // ['] (39)
    [
    ...
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x30, 0x30, 0x10, 0x20, 0x00,
        0x00,
    ], // [,] (44)
    [
    ...
    [
        0x00, 0x00, 0x00, 0x02, 0x06, 0x0c, 0x18, 0x30, 0x60, 0xc0, 0x80, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ], // [/] (47)
    [
    ...
    [
        0x00, 0x00, 0x0c, 0x1c, 0x3c, 0x6c, 0xcc, 0xcc, 0xfe, 0x0c, 0x0c, 0x1e, 0x00, 0x00, 0x00,
        0x00,
    ], // [4] (52)
    [
    ...
    [
        0x00, 0x00, 0x00, 0x00, 0x18, 0x18, 0x00, 0x00, 0x00, 0x18, 0x18, 0x08, 0x10, 0x00, 0x00,
        0x00,
    ], // [;] (59)
    [
    ...
    [
        0x00, 0x00, 0x7c, 0xc6, 0xc6, 0x06, 0x0c, 0x18, 0x18, 0x00, 0x18, 0x18, 0x00, 0x00, 0x00,
        0x00,
    ], // [?] (63)
    [
        0x00, 0x00, 0x00, 0x3c, 0x42, 0x9d, 0xa5, 0xa5, 0xad, 0xb6, 0x40, 0x3c, 0x00, 0x00, 0x00,
        0x00,
    ], // [@] (64)
    [
        0x00, 0x00, 0x38, 0x6c, 0xc6, 0xc6, 0xc6, 0xfe, 0xc6, 0xc6, 0xc6, 0xc6, 0x00, 0x00, 0x00,
        0x00,
    ], // [A] (65)
    [
    ...
    [
        0x00, 0x00, 0x7c, 0xc6, 0xc6, 0xc0, 0xc0, 0xc0, 0xc0, 0xc6, 0xc6, 0x7c, 0x00, 0x00, 0x00,
        0x00,
    ], // [C] (67)
    [
        0x00, 0x00, 0xfc, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0xfc, 0x00, 0x00, 0x00,
        0x00,
    ], // [D] (68)
    [
        0x00, 0x00, 0xfe, 0x66, 0x62, 0x68, 0x78, 0x78, 0x68, 0x62, 0x66, 0xfe, 0x00, 0x00, 0x00,
        0x00,
    ], // [E] (69)
    [
        0x00, 0x00, 0xfe, 0x66, 0x62, 0x68, 0x78, 0x78, 0x68, 0x60, 0x60, 0xf0, 0x00, 0x00, 0x00,
        0x00,
    ], // [F] (70)
    [
        0x00, 0x00, 0x7c, 0xc6, 0xc6, 0xc0, 0xc0, 0xce, 0xc6, 0xc6, 0xc6, 0x7e, 0x00, 0x00, 0x00,
        0x00,
    ], // [G] (71)
    [
    ...
    [
        0x00, 0x00, 0x82, 0xc6, 0xee, 0xfe, 0xfe, 0xd6, 0xc6, 0xc6, 0xc6, 0xc6, 0x00, 0x00, 0x00,
        0x00,
    ], // [M] (77)
    [
        0x00, 0x00, 0x86, 0xc6, 0xe6, 0xf6, 0xfe, 0xde, 0xce, 0xc6, 0xc6, 0xc6, 0x00, 0x00, 0x00,
        0x00,
    ], // [N] (78)
    [
    ...
    [
        0x00, 0x00, 0xfc, 0x66, 0x66, 0x66, 0x66, 0x7c, 0x60, 0x60, 0x60, 0xf0, 0x00, 0x00, 0x00,
        0x00,
    ], // [P] (80)
    [
        0x00, 0x00, 0x7c, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xd6, 0xde, 0x7c, 0x06, 0x00, 0x00,
        0x00,
    ], // [Q] (81)
    [
        0x00, 0x00, 0xfc, 0x66, 0x66, 0x66, 0x66, 0x7c, 0x6c, 0x66, 0x66, 0xe6, 0x00, 0x00, 0x00,
        0x00,
    ], // [R] (82)
    [
    ...
    [
        0x00, 0x00, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xd6, 0xfe, 0xee, 0xc6, 0x82, 0x00, 0x00, 0x00,
        0x00,
    ], // [W] (87)
    [
    ...
    [
        0x00, 0x18, 0x18, 0x10, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ], // [`] (96)
    [
    ...
    [
        0x00, 0x00, 0xe0, 0x60, 0x60, 0x7c, 0x66, 0x66, 0x66, 0x66, 0x66, 0x7c, 0x00, 0x00, 0x00,
        0x00,
    ], // [b] (98)
    [
    ...
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x7c, 0xc6, 0xc6, 0xfe, 0xc0, 0xc6, 0x7c, 0x00, 0x00, 0x00,
        0x00,
    ], // [e] (101)
    [
        0x00, 0x00, 0x1c, 0x36, 0x30, 0x7c, 0x30, 0x30, 0x30, 0x30, 0x30, 0x78, 0x00, 0x00, 0x00,
        0x00,
    ], // [f] (102)
    [
    ...
    [
        0x00, 0x00, 0x0c, 0x0c, 0x00, 0x1c, 0x0c, 0x0c, 0x0c, 0x0c, 0x0c, 0x0c, 0xcc, 0xcc, 0x78,
        0x00,
    ], // [j] (106)
    [
    ...
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x7c, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0x7c, 0x0c, 0x0c, 0x1e,
        0x00,
    ], // [q] (113)
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0xde, 0x76, 0x60, 0x60, 0x60, 0x60, 0xf0, 0x00, 0x00, 0x00,
        0x00,
    ], // [r] (114)
    [
    ...
    [
        0x00, 0x00, 0x10, 0x30, 0x30, 0xfc, 0x30, 0x30, 0x30, 0x30, 0x34, 0x18, 0x00, 0x00, 0x00,
        0x00,
    ], // [t] (116)
    [
    ...
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0xc6, 0xd6, 0xd6, 0xd6, 0xd6, 0xfe, 0x6c, 0x00, 0x00, 0x00,
        0x00,
    ], // [w] (119)
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0xc6, 0xc6, 0x6c, 0x38, 0x6c, 0xc6, 0xc6, 0x00, 0x00, 0x00,
        0x00,
    ], // [x] (120)
    [
    ...
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0xfe, 0x8c, 0x18, 0x30, 0x60, 0xc2, 0xfe, 0x00, 0x00, 0x00,
        0x00,
    ], // [z] (122)
    [
    ...
    [
        0x00, 0x00, 0x18, 0x18, 0x18, 0x18, 0x00, 0x00, 0x18, 0x18, 0x18, 0x18, 0x00, 0x00, 0x00,
        0x00,
    ], // [|] (124)
    [
    ...
    [
        0x00, 0x00, 0x7c, 0xc6, 0xc6, 0xc0, 0xc0, 0xc0, 0xc0, 0xc6, 0xc6, 0x7c, 0x10, 0x08, 0x70,
        0x00,
    ], // [Ç] (128)
    [
    ...
    [
        0x00, 0x06, 0x0c, 0x10, 0x00, 0x7c, 0xc6, 0xc6, 0xfe, 0xc0, 0xc6, 0x7c, 0x00, 0x00, 0x00,
        0x00,
    ], // [é] (130)
    [
        0x00, 0x30, 0x78, 0xcc, 0x00, 0x78, 0x0c, 0x7c, 0xcc, 0xcc, 0xcc, 0x76, 0x00, 0x00, 0x00,
        0x00,
    ], // [â] (131)
    [
    ...
    [
        0x00, 0xc0, 0x60, 0x10, 0x00, 0x78, 0x0c, 0x7c, 0xcc, 0xcc, 0xcc, 0x76, 0x00, 0x00, 0x00,
        0x00,
    ], // [à] (133)
    [
        0x00, 0x30, 0x48, 0x30, 0x00, 0x78, 0x0c, 0x7c, 0xcc, 0xcc, 0xcc, 0x76, 0x00, 0x00, 0x00,
        0x00,
    ], // [å] (134)
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x7c, 0xc6, 0xc0, 0xc0, 0xc0, 0xc6, 0x7c, 0x10, 0x08, 0x70,
        0x00,
    ], // [ç] (135)
    [
        0x00, 0x18, 0x3c, 0x66, 0x00, 0x7c, 0xc6, 0xc6, 0xfe, 0xc0, 0xc6, 0x7c, 0x00, 0x00, 0x00,
        0x00,
    ], // [ê] (136)
    [
        0x00, 0x00, 0xc6, 0xc6, 0x00, 0x7c, 0xc6, 0xc6, 0xfe, 0xc0, 0xc6, 0x7c, 0x00, 0x00, 0x00,
        0x00,
    ], // [ë] (137)
    [
        0x00, 0xc0, 0x60, 0x10, 0x00, 0x7c, 0xc6, 0xc6, 0xfe, 0xc0, 0xc6, 0x7c, 0x00, 0x00, 0x00,
        0x00,
    ], // [è] (138)
    [
    ...
    [
        0x00, 0xc0, 0x60, 0x10, 0x00, 0x38, 0x18, 0x18, 0x18, 0x18, 0x18, 0x3c, 0x00, 0x00, 0x00,
        0x00,
    ], // [ì] (141)
    [
        0xc6, 0xc6, 0x00, 0x38, 0x6c, 0xc6, 0xc6, 0xfe, 0xc6, 0xc6, 0xc6, 0xc6, 0x00, 0x00, 0x00,
        0x00,
    ], // [Ä] (142)
    [
        0x38, 0x44, 0x38, 0x38, 0x6c, 0xc6, 0xc6, 0xfe, 0xc6, 0xc6, 0xc6, 0xc6, 0x00, 0x00, 0x00,
        0x00,
    ], // [Å] (143)
    [
        0x0c, 0x18, 0x20, 0xfe, 0x66, 0x62, 0x68, 0x78, 0x68, 0x62, 0x66, 0xfe, 0x00, 0x00, 0x00,
        0x00,
    ], // [É] (144)
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x7c, 0x12, 0x72, 0x9e, 0x90, 0x92, 0x7c, 0x00, 0x00, 0x00,
        0x00,
    ], // [æ] (145)
    [
        0x00, 0x00, 0x3e, 0x6a, 0xc8, 0xc8, 0xcc, 0xfc, 0xc8, 0xc8, 0xca, 0xce, 0x00, 0x00, 0x00,
        0x00,
    ], // [Æ] (146)
    [
        0x00, 0x18, 0x3c, 0x66, 0x00, 0x7c, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0x7c, 0x00, 0x00, 0x00,
        0x00,
    ], // [ô] (147)
    [
    ...
    [
        0x00, 0xc0, 0x60, 0x10, 0x00, 0x7c, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0x7c, 0x00, 0x00, 0x00,
        0x00,
    ], // [ò] (149)
    [
    ...
    [
        0x00, 0xc0, 0x60, 0x10, 0x00, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0x76, 0x00, 0x00, 0x00,
        0x00,
    ], // [ù] (151)
    [
    ...
    [
        0xc6, 0xc6, 0x00, 0x7c, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0x7c, 0x00, 0x00, 0x00,
        0x00,
    ], // [Ö] (153)
    [
        0xc6, 0xc6, 0x00, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0x7c, 0x00, 0x00, 0x00,
        0x00,
    ], // [Ü] (154)
    [
        0x00, 0x00, 0x10, 0x10, 0x7c, 0xd6, 0xd0, 0xd0, 0xd6, 0x7c, 0x10, 0x10, 0x00, 0x00, 0x00,
        0x00,
    ], // [¢] (155)
    [
        0x00, 0x00, 0x38, 0x6c, 0x60, 0xf0, 0x60, 0x60, 0x60, 0x60, 0xf2, 0xdc, 0x00, 0x00, 0x00,
        0x00,
    ], // [£] (156)
    [
        0x00, 0x00, 0x66, 0x66, 0x66, 0x3c, 0x18, 0x7e, 0x18, 0x7e, 0x18, 0x18, 0x00, 0x00, 0x00,
        0x00,
    ], // [¥] (157)
    [
        0x00, 0x00, 0xf8, 0xcc, 0xcc, 0xf8, 0xc4, 0xcc, 0xde, 0xcc, 0xcc, 0xc6, 0x00, 0x00, 0x00,
        0x00,
    ], // [₧] (158)
    [
        0x00, 0x00, 0x0e, 0x1b, 0x18, 0x18, 0x7e, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0xd8, 0x70,
        0x00,
    ], // [ƒ] (159)
    [
        0x00, 0x06, 0x0c, 0x10, 0x00, 0x78, 0x0c, 0x7c, 0xcc, 0xcc, 0xcc, 0x76, 0x00, 0x00, 0x00,
        0x00,
    ], // [á] (160)
    [
        0x00, 0x06, 0x0c, 0x10, 0x00, 0x38, 0x18, 0x18, 0x18, 0x18, 0x18, 0x3c, 0x00, 0x00, 0x00,
        0x00,
    ], // [í] (161)
    [
        0x00, 0x06, 0x0c, 0x10, 0x00, 0x7c, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0x7c, 0x00, 0x00, 0x00,
        0x00,
    ], // [ó] (162)
    [
        0x00, 0x06, 0x0c, 0x10, 0x00, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0x76, 0x00, 0x00, 0x00,
        0x00,
    ], // [ú] (163)
    [
    ...
    [
        0x76, 0xdc, 0x00, 0x86, 0xc6, 0xe6, 0xf6, 0xfe, 0xde, 0xce, 0xc6, 0xc6, 0x00, 0x00, 0x00,
        0x00,
    ], // [Ñ] (165)
    [
        0x00, 0x38, 0x0c, 0x3c, 0x6c, 0x36, 0x00, 0x7e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ], // [ª] (166)
    [
        0x00, 0x00, 0x3c, 0x66, 0x66, 0x3c, 0x00, 0x7e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ], // [º] (167)
    [
    ...
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xfe, 0xc0, 0xc0, 0xc0, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ], // [⌐] (169)
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xfe, 0x06, 0x06, 0x06, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ], // [¬] (170)
    [
        0x00, 0x60, 0xe0, 0x64, 0x6c, 0x78, 0x30, 0x60, 0xdc, 0xb6, 0x0c, 0x18, 0x3e, 0x00, 0x00,
        0x00,
    ], // [½] (171)
    [
        0x00, 0x60, 0xe0, 0x64, 0x6c, 0x78, 0x30, 0x6c, 0xdc, 0xac, 0x3e, 0x0c, 0x0c, 0x00, 0x00,
        0x00,
    ], // [¼] (172)
    [
    ...
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x74, 0xdc, 0xc8, 0xc8, 0xc8, 0xdc, 0x76, 0x00, 0x00, 0x00,
        0x00,
    ], // [α] (224)
    [
        0x00, 0x00, 0x78, 0xcc, 0xcc, 0xd8, 0xcc, 0xc6, 0xc6, 0xc6, 0xdc, 0xc0, 0x40, 0x00, 0x00,
        0x00,
    ], // [ß] (225)
    [
        0x00, 0x00, 0xfe, 0x62, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0xf0, 0x00, 0x00, 0x00,
        0x00,
    ], // [Γ] (226)
    [
        0x00, 0x00, 0x00, 0x00, 0x02, 0x7e, 0xec, 0x6c, 0x6c, 0x6c, 0x6c, 0x48, 0x00, 0x00, 0x00,
        0x00,
    ], // [π] (227)
    [
        0x00, 0x00, 0xfe, 0xc2, 0x60, 0x30, 0x18, 0x30, 0x60, 0xc0, 0xc2, 0xfe, 0x00, 0x00, 0x00,
        0x00,
    ], // [Σ] (228)
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x7e, 0xd0, 0xc8, 0xc8, 0xc8, 0xc8, 0x70, 0x00, 0x00, 0x00,
        0x00,
    ], // [σ] (229)
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xf8, 0x80, 0x80, 0x00,
        0x00,
    ], // [µ] (230)
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x7e, 0xd8, 0x18, 0x18, 0x18, 0x18, 0x10, 0x00, 0x00, 0x00,
        0x00,
    ], // [τ] (231)
    [
        0x00, 0x00, 0x38, 0x10, 0x7c, 0xd6, 0xd6, 0xd6, 0xd6, 0x7c, 0x10, 0x38, 0x00, 0x00, 0x00,
        0x00,
    ], // [Φ] (232)
    [
        0x00, 0x00, 0x00, 0x7c, 0xc6, 0xc6, 0xc6, 0xfe, 0xc6, 0xc6, 0xc6, 0x7c, 0x00, 0x00, 0x00,
        0x00,
    ], // [Θ] (233)
    [
        0x00, 0x00, 0x7c, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0x6c, 0x28, 0x28, 0xee, 0x00, 0x00, 0x00,
        0x00,
    ], // [Ω] (234)
    [
        0x00, 0x00, 0x3c, 0x62, 0x30, 0x18, 0x7c, 0xcc, 0xcc, 0xcc, 0xcc, 0x78, 0x00, 0x00, 0x00,
        0x00,
    ], // [δ] (235)
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x6e, 0xdb, 0xdb, 0xdb, 0x76, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ], // [∞] (236)
    [
        0x00, 0x00, 0x00, 0x02, 0x06, 0x7c, 0xce, 0xde, 0xd6, 0xf6, 0xe6, 0x7c, 0xc0, 0x80, 0x00,
        0x00,
    ], // [φ] (237)
    [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x3c, 0x60, 0xc0, 0xf8, 0xc0, 0x60, 0x3c, 0x00, 0x00, 0x00,
        0x00,
    ], // [ε] (238)
    [
        0x00, 0x00, 0x7c, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0x00, 0x00, 0x00,
        0x00,
    ], // [∩] (239)
    [
    ...
    [
        0x00, 0x00, 0x00, 0x60, 0x30, 0x18, 0x0c, 0x18, 0x30, 0x60, 0x00, 0xfe, 0x00, 0x00, 0x00,
        0x00,
    ], // [≥] (242)
    [
        0x00, 0x00, 0x00, 0x0c, 0x18, 0x30, 0x60, 0x30, 0x18, 0x0c, 0x00, 0xfe, 0x00, 0x00, 0x00,
        0x00,
    ], // [≤] (243)
    [
    ...
    [
        0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0xd8, 0xd8, 0x70, 0x00, 0x00, 0x00,
        0x00,
    ], // [⌡] (245)
    [
    ...
    [
        0x00, 0xd8, 0x6c, 0x6c, 0x6c, 0x6c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ], // [ⁿ] (252)
    [
        0x00, 0x38, 0x4c, 0x0c, 0x18, 0x30, 0x7c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ], // [²] (253)
    [
