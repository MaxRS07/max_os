...
pub const INPUT_PROP_BUTTONPAD: u16 = 0x02; /* has button(s) under pad */
...
pub const INPUT_PROP_PRESSUREPAD: u16 = 0x07; /* pressure triggers clicks */
...
pub const KEY_FULL_SCREEN: u16 = 0x174; /* AC View Toggle */
pub const KEY_ZOOM: u16 = KEY_FULL_SCREEN;
pub const KEY_MODE: u16 = 0x175;
pub const KEY_KEYBOARD: u16 = 0x176;
pub const KEY_ASPECT_RATIO: u16 = 0x177; /* HUTRR37: Aspect */
...
pub const KEY_DISPLAYTOGGLE: u16 = 0x1af; /* Turn display (LCD) on and off */
...
pub const KEY_10CHANNELSUP: u16 = 0x1b8; /* 10 channels up (10+) */
pub const KEY_10CHANNELSDOWN: u16 = 0x1b9; /* 10 channels down (10-) */
pub const KEY_IMAGES: u16 = 0x1ba; /* AL Image Browser */
pub const KEY_NOTIFICATION_CENTER: u16 = 0x1bc; /* Show/hide the notification center */
pub const KEY_PICKUP_PHONE: u16 = 0x1bd; /* Answer incoming call */
pub const KEY_HANGUP_PHONE: u16 = 0x1be; /* Decline incoming call */
pub const KEY_LINK_PHONE: u16 = 0x1bf; /* AL Phone Syncing */
...
pub const KEY_ROTATE_LOCK_TOGGLE: u16 = 0x231; /* Display rotation lock */
pub const KEY_REFRESH_RATE_TOGGLE: u16 = 0x232; /* Display refresh rate toggle */
...
pub const KEY_ASSISTANT: u16 = 0x247; /* AL Context-aware desktop assistant */
pub const KEY_KBD_LAYOUT_NEXT: u16 = 0x248; /* AC Next Keyboard Layout Select */
pub const KEY_EMOJI_PICKER: u16 = 0x249; /* Show/hide emoji picker (HUTRR101) */
pub const KEY_DICTATE: u16 = 0x24a; /* Start or Stop Voice Dictation Session (HUTRR99) */
pub const KEY_CAMERA_ACCESS_ENABLE: u16 = 0x24b; /* Enables programmatic access to camera devices. (HUTRR72) */
pub const KEY_CAMERA_ACCESS_DISABLE: u16 = 0x24c; /* Disables programmatic access to camera devices. (HUTRR72) */
pub const KEY_CAMERA_ACCESS_TOGGLE: u16 = 0x24d; /* Toggles the current state of the camera access control. (HUTRR72) */
pub const KEY_ACCESSIBILITY: u16 = 0x24e; /* Toggles the system bound accessibility UI/command (HUTRR116) */
pub const KEY_DO_NOT_DISTURB: u16 = 0x24f; /* Toggles the system-wide "Do Not Disturb" control (HUTRR94)*/
...
pub const KEY_ACTION_ON_SELECTION: u16 = 0x254; /* AL Action on Selection (HUTRR119) */
pub const KEY_CONTEXTUAL_INSERT: u16 = 0x255; /* AL Contextual Insertion (HUTRR119) */
pub const KEY_CONTEXTUAL_QUERY: u16 = 0x256; /* AL Contextual Query (HUTRR119) */
...
pub const KEY_ROOT_MENU: u16 = 0x26a; /* Show Device's Root Menu */
...
pub const KEY_VOD: u16 = 0x273; /* Video on Demand */
...
pub const SW_RFKILL_ALL: u16 = 0x03; /* rfkill master switch, type "any"
set = radio enabled */
...
pub const SW_PEN_INSERTED: u16 = 0x0f; /* set = pen inserted */
pub const SW_MACHINE_COVER: u16 = 0x10; /* set = cover closed */
pub const SW_USB_INSERT: u16 = 0x11; /* set = USB audio device connected */
